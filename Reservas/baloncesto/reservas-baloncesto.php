...
<body>
    ...
    <h1 class="titulo-deporte">BALONCESTO</h1>

    <details class="panel">

        <summary class="panel-header">

            <img src="baloncestocubierto.png" alt="Pista Cubierta">

            <div class="header-info">
                <span class="titulo">Pista Cubierta 1</span>
                <span class="precio">25€/partido</span>
            </div>
            ...
            <div class="contenido">
                ...
                <div class="horario-grid">
                    ...
                    <a href="formulario-baloncesto.html" class="slot disponible">11:00</a>
                    <div class="slot ocupado">12:00</div>
                    <a href="formulario-baloncesto.html" class="slot disponible">16:00</a>
                    <div class="slot ocupado">17:00</div>
                    <a href="formulario-baloncesto.html" class="slot disponible">18:00</a>
                    <a href="formulario-baloncesto.html" class="slot disponible">19:00</a>
                    <div class="slot ocupado">20:00</div>
                    <a href="formulario-baloncesto.html" class="slot disponible">21:00</a>
                    <a href="formulario-baloncesto.html" class="slot disponible">22:00</a>
    ...
    <details class="panel">
        ...
        <summary class="panel-header">
            ...
            <img src="baloncestoexterior.jpg" alt="Pista Exterior">

            <div class="header-info">
                <span class="titulo">Pista Exterior</span>
                <span class="precio">25€/partido</span>
            </div>
